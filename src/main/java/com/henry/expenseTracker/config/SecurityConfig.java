...
//    }
    ...
    public TokenSettings tokenSettings(){
        return TokenSettings.builder()
                ...
                .accessTokenTimeToLive(Duration.ofMinutes(120L))
                .build();
    }
    ...
    public JwtGrantedAuthoritiesConverter jwtGrantedAuthoritiesConverter(){
        ...
        converter.setAuthorityPrefix(""); // para quitar el prefijo "SCOPE" del granted_authority de userDetails
        return converter;
    }
    ...
    /*
    ** @dev para agregar propiedades personalizadas al Jwt Token
     */
    @Bean
    ...
    private static RSAKey generateKeys() throws NoSuchAlgorithmException {
